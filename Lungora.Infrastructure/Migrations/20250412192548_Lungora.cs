...
{
    /// <inheritdoc />
    public partial class Lungora : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumOfPatients = table.Column<int>(type: "int", nullable: false),
                    About = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    EmailDoctor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Phone = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: false),
                    Teliphone = table.Column<string>(type: "nvarchar(12)", maxLength: 12, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TbDoctors_TbCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "TbCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TbWorkingHours", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TbWorkingHours_TbDoctors_DoctorId",
                        column: x => x.DoctorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TbDoctors_CategoryId",
                table: "TbDoctors",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_TbWorkingHours_DoctorId_DayOfWeek",
                table: "TbWorkingHours",
